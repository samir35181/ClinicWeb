...
if ($_SERVER['REQUEST_METHOD'] == 'GET')
{
    ...
    {
      //Mostrar un post
      $sql = $dbConn->prepare("SELECT * FROM _paciente_medicion where id=:id");
      ...
      $sql = $dbConn->prepare("SELECT * FROM _paciente_medicion");
      $sql->execute();
...
{
    $input = $_POST;
    $sql = "INSERT INTO _paciente_medicion
          (paciente, peso , edad, genero, id_medicion, tipo_medicion, valor, hora, fecha, duracion)
          VALUES
          (:paciente, :peso , :edad, :genero, :id_medicion, :tipo_medicion, :valor, :hora, :fecha, :duracion)";
...
{
	$id = $_GET['id'];
  $statement = $dbConn->prepare("DELETE FROM _paciente_medicion where id=:id");
